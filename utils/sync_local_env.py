...
if __name__ == "__main__":
    sync_local_from_stage("raw_data/youbike_dock_info_202", limit=20)
    sync_local_from_stage("clean_data/youbike_dock_info_202", limit=20)
    sync_local_from_stage("raw_data/weather/forecast_report", limit=1)
    sync_local_from_stage("raw_data/weather/forecast_report", limit=0)
